...
OBJECTS = src/amxxmodule.cpp src/cfunction.cpp src/chldsprocess.cpp src/chookmanager.cpp src/jit.cpp src/cmodule.cpp src/config.cpp src/sdk/interface.cpp src/meta_api.cpp src/mod_rehlds_api.cpp src/natives.cpp src/repatcher.cpp src/utils.cpp src/libudis86.a
